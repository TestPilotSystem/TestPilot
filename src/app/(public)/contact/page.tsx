      ...
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        >
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Conoce al <span className="text-brand-light font-semibold">desarrollador</span> detrás de TestPilot.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-surface/80 backdrop-blur-md rounded-3xl shadow-xl border border-slate-700/50 overflow-hidden hover:border-slate-600 transition-all duration-300"
        >
          <div className="md:flex items-center">
            <div className="md:shrink-0 p-10 md:w-72 flex items-center justify-center">
              <div className="relative h-48 w-48 shadow-xl rounded-full border-4 border-slate-700 overflow-hidden transform hover:scale-105 transition-transform duration-300">
                <Image
            ...
            <div className="p-8 md:p-12 flex-1">
              <div className="uppercase tracking-wide text-sm text-accent font-bold mb-2">Desarrollador</div>
              <h2 className="block text-3xl leading-tight font-bold text-slate-50 mb-2">Jesús Sánchez Quirós</h2>
              ...
              <div className="mt-6 flex items-center gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-slate-700 to-slate-800 text-white rounded-xl font-medium text-sm hover:from-slate-800 hover:to-slate-900 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-brand to-brand-light text-white rounded-xl font-medium text-sm hover:opacity-90 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5"
                >
